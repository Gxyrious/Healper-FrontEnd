...
<template>
    ...
    <el-table-column prop="consultantRealName" label="咨询师" width="200" />
  ...
  -->
    ...
    <el-col :span="7">
  <el-pagination layout="prev, pager, next" :total="documentSum" v-model:current-page="page" @current-change="getNewPage"/>
</el-col>
  </el-row>
        </el-main>
    </el-container>
