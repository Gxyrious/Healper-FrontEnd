        ...
        <el-col :span="23">
          <el-tabs v-model="activeName">
            <el-tab-pane label="统计分析" name="first">
              <AnalysisChart v-for="item in analysis" :key="item.factor" :factor="item.factor" :detail="item.detail">
              </AnalysisChart>
            </el-tab-pane>
            <el-tab-pane label="历史记录" name="second">
              <el-table :data="scaleRecord" style="width: 100%">
                ...
                <el-table-column label="操作">
                  <template #default="scope">
                    ...
                    <el-popconfirm title="您确定要删除这条测评记录吗？" confirm-button-text="是" cancel-button-text="否"
                      @confirm="deleteRecord(scope.row.scaleRecordId)">
              ...
              <el-row justify="center" style="margin-top: 30px;">
                <el-col :span="7">
                  <el-pagination layout="prev, pager, next" :total="scaleSum" v-model:current-page="page"
